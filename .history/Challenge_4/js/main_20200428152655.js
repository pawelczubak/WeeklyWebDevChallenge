...
const fallowButtonTwitter = () => {
    const twitterWidget = document.querySelector("#twitter");
    const btnFallow = twitterWidget.querySelector(".fallow-user__button");
    const result = twitterWidget.querySelector(".fallow-user__fallow");
